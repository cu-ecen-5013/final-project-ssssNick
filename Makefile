...
all : clean_all subdir_lcd-util_all subdir_prj_base_all subdir_lcd-test_all $(EXE)
...
clean_all : subdir_lcd-util_clean subdir_prj_base_clean subdir_lcd-test_clean
	rm -f $(EXE)
